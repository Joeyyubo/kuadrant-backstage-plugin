#!/bin/bash
# Template script to generate updated catalog-info.yaml with correct GitHub Pages URL
# This script extracts repo owner and name from remoteUrl and generates the correct catalog-info.yaml
...
if [[ $REMOTE_URL =~ github\.com/([^/]+)/([^/]+) ]]; then
  ...
  # Generate updated catalog-info.yaml
